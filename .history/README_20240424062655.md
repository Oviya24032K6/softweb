        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(226, 175, 8, 0.836),rgba(130, 9, 109, 0.625));
...
<body>
    ...
    <footer>
        <center> Designed and Developed by OVIYA P (212223110033) </center>
    </footer>
</body>
</html>
product.html
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(182, 213, 8, 0.75),rgba(135, 11, 83, 0.75));
                background-size: cover;
                background-position: center;
            }
            .navbar {
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(199, 224, 33, 0.75),rgba(147, 27, 137, 0.75));
                background-size: cover;
                background-position: center;
            }
            .navbar {
            ...
            .logo {
                color:C:\Users\poviy\softweb\oviya\softapp\static\home.html;
                font-size: 40px;
                font-weight: 700;
                letter-spacing: 3px;
            }
    ...
    <div class="banner">
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="oviya pic.jpg"> </td>
                    <td> <img src="roshhhh.jpg"> </td>
                    <td> <img src="vijay devarkonda.jpg"> </td>
                    <td> <img src="sk.jpg"> </td>
                    <td> <img src="nazriya.jpg"> </td>
                </tr>
                <tr align="center">
                    <th> OVIYA </th>
                    <th> ROSHAN</th>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(134, 174, 32, 0.75),rgba(170, 27, 110, 0.75));
                background-size: cover;
                background-position: center;
            }
            .navbar {''
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : 6/68,P.K.PURAM,VELLORE-632209 </p>
                <p> <span>Email</span> : oviyap24032k7@gmail.com </p>
                <p> <span>Phone</span> : 9360934439 </p>
            </div>
        </div>
    </div>
    <footer>
        <center> Designed and Developed OVIYA P (212223110033) </center>
    </footer>
</body>
</html>
